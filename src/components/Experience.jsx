    ...
    return [
      {
        ...
        title: "Começo",
        subtitle: `Eu aos 15 anos comecei a estudar segurança da informação porém não era isso que eu queria`,
      },
      {
        cameraRailDist: 1.5,
        position: new Vector3(
        ...
        title: "Mudança",
        subtitle: `Explorava e aprendia tudo em um Sansung Galaxy win 2, mas ao entrar em sources de websites comecei a mudar minha jornada para html, css e js por curiosidade.`,
      },
      {
        cameraRailDist: -1,
        position: new Vector3(
        ...
        title: "A decisão",
        subtitle: `E isso foi um alivio mudar pois estava tendo muito reconhecimento e propostas de todos os tipos em uma área que eu não sabia se queria seguir ou só me divertir.`,
      },
      {
        cameraRailDist: 1.5,
        position: new Vector3(
